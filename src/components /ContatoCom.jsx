    ...
    return (
        <div>
            ...
            <div>
                ...
                <Popup contentStyle={{background: '#4aa8ef', width: '50%', maxWidth: '600px'}} arrowStyle={{display: 'none'}} trigger={<button className='button'>Começar</button>} position="top center">
